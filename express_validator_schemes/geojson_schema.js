...
This schema is documented extensively to help understanding the used library*/
// TODO: Die einzelnen Tests genauer auf ihre korrektheit prüfen, nachdem andere Funktionalität steht
const GEOJSON_ADD_SCHEMA = 
{
    'type': {
...
// This is schema desinged for the structure of the request body send via the route "/update_station"
const GEOJSON_UPDATE_SCHEMA = 
{
    'geojson.type': {
        // the validator method "equals(str, comparison)" from validator.js
        equals: {
...
module.exports = {GEOJSON_ADD_SCHEMA, GEOJSON_UPDATE_SCHEMA}